...
int main() {
    ...
    T.printOrdered();
    T.treeInsert(new binNode <int>(7));
    T.printOrdered();
    T.treeInsert(new binNode <int>(9));
    T.printOrdered();
    T.treeInsert(new binNode <int>(11));
    T.printOrdered();
    T.treeInsert(new binNode <int>(13));
    T.printOrdered();
    T.treeInsert(new binNode <int>(15));
    T.printOrdered();
    T.treeInsert(new binNode <int>(17));
    T.printOrdered();
    T.treeInsert(new binNode <int>(19));
    T.printOrdered();
    T.treeInsert(new binNode <int>(21));
    T.printOrdered();

    
    // delete find;
	cout << "After deleting key=3:\n";
	find = T.treeSearch(3);
	T.treeDelete(find);
	T.printOrdered();
